...
[![Version](https://img.shields.io/badge/version-1.0.18-blue.svg)](https://github.com/markhazleton/tailwind-demo) [![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE) [![React](https://img.shields.io/badge/React-19.1.1-61dafb.svg)](https://reactjs.org/) [![TypeScript](https://im Built with HTML. Actively maintained with regular updates.
...
[![.NET](https://img.shields.io/badge/.NET-10.0-blue.svg)](https://dotnet.microsoft.com/download/dotnet/10.0) [![License](https://img.shields.io/github/license/markhazleton/RESTRunner)](https://github.com/markhazleton/RESTRunner/blob/main/LICENSE) [![Build Status](https://img.shields.io/github/actio Built with C#. Actively maintained with regular updates.
...
[![GitHub Stars](https://img.shields.io/github/stars/markhazleton/js-dev-env?style=for-the-badge&logo=github)](https://github.com/markhazleton/js-dev-env/stargazers) [![GitHub Forks](https://img.shields.io/github/forks/markhazleton/js-dev-env?style=for-the-badge&logo=github)](https://github.com/mark Built with JavaScript. Actively maintained with regular updates.
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/markhazleton/ReactSparkPortfolio?tab=MIT-1-ov-file) [![GitHub stars](https://img.shields.io/github/stars/markhazleton/ReactSparkPortfolio)](https://github.com/markhazleton/ReactSparkPortfolio/stargazers) [![Git Built with CSS. Maintained project with periodic updates.
...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE) ![.NET](https://img.shields.io/badge/.NET-10.0-512BD4) ![Platform](https://img.shields.io/badge/platform-Windows-lightgrey) Built with C#. Actively maintained with regular updates.
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) Built with HTML. Maintained project with periodic updates.
...
[![.NET Version](https://img.shields.io/badge/.NET-10.0-512BD4?logo=dotnet)](https://dotnet.microsoft.com/) [![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE) [![Build Status](https://img.shields.io/badge/build-passing-brightgreen.svg)]() [![PRs Welcome](https://img.shields.io/ Built with C#. Key features: 📝 **Interactive Conversation Interface** - Real-time question/answer flow, 🎯 **Multiple Question Types** - Text inputs, single-select, and multi-select, 📊 **Spec Selection** - Choose from available decision specifications. Actively maintained with regular updates.
...
[![.NET](https://img.shields.io/badge/.NET-10.0-512BD4?style=flat-square&logo=dotnet)](https://dotnet.microsoft.com/) [![License](https://img.shields.io/badge/License-MIT-green.svg?style=flat-square)](LICENSE) [![Build Status](https://img.shields.io/badge/Build-Passing-brightgreen?style=flat-square) Built with C#. Actively maintained with regular updates.
...
[![.NET](https://img.shields.io/badge/.NET-9.0-purple.svg)](https://dotnet.microsoft.com/download) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) [![Build](https://img.shields.io/github/actions/workflow/status/markhazleton/sql2csv/ci.yml?branch=main)](https://github. Built with C#. Maintained project with periodic updates.
...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-phpdocspark.azurewebsites.net-blue?style=for-the-badge)](https://phpdocspark.azurewebsites.net/) [![Canonical](https://img.shields.io/badge/Canonical-phpdocspark.markhazleton.com-orange?style=for-the-badge)](https://phpdocspark.markhazleton.com) Built with PHP. Maintained project with periodic updates.
...
[![Build and deploy ASP.Net Core app to Azure Web App - HttpClientDecoratorPattern](https://github.com/markhazleton/HttpClientDecoratorPattern/actions/workflows/main_httpclientdecoratorpattern.yml/badge.svg)](https://github.com/markhazleton/HttpClientDecoratorPattern/actions/workflows/main_httpclien Built with HTML. Maintained project with periodic updates.
...
[![NuGet stable version](https://img.shields.io/nuget/v/openai.svg)](https://www.nuget.org/packages/OpenAI) [![NuGet preview version](https://img.shields.io/nuget/vpre/openai.svg)](https://www.nuget.org/packages/OpenAI/absoluteLatest) Maintained project with periodic updates.
...
[![NuGet](https://img.shields.io/nuget/v/WebSpark.SharedKernel.svg)](https://www.nuget.org/packages/WebSpark.SharedKernel/) [![NuGet Downloads](https://img.shields.io/nuget/dt/WebSpark.SharedKernel.svg)](https://www.nuget.org/packages/WebSpark.SharedKernel/) [![License: MIT](https://img.shields.io/b Built with C#. Maintained project with periodic updates.
