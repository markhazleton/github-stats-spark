...
- Frontend: React 18+, Vite 5+, Recharts 2.x, CSS Modules (built-in with Vite)
**Storage**: Static JSON files generated by Python backend, served from `/docs` directory via GitHub Pages
