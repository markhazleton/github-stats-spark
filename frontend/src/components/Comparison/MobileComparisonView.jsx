    ...
    <div className="mobile-comparison-view" {...bind()}>
      ...
      <div className="mobile-comparison-header">
        ...
        <div className="mobile-comparison-pagination">
          <span>
            {currentMetricIndex + 1} of {comparisonMetrics.length}
          </span>
      ...
      {/* Swipe hint */}
      <p className="mobile-comparison-hint">← Swipe to navigate metrics →</p>
      ...
      <div className="mobile-comparison-cards">
        {repositories.map((repo) => {
          ...
          const numericValue =
            currentMetric.type === "number" ? Number(value) || 0 : 0;
          const barWidth =
                ...
                {currentMetric.type === "number" && (
                  <div className="mobile-comparison-rank">
                    {numericValue === maxValue && (
                      <span className="rank-badge rank-highest">
                        🥇 Highest
                      </span>
                    )}
                    {numericValue ===
        ...
        <button
          ...
          onClick={() =>
            setCurrentMetricIndex((prev) =>
              Math.min(comparisonMetrics.length - 1, prev + 1),
            )
          }
